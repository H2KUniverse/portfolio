...
import { FaGithub, FaCogs } from 'react-icons/fa'; // Import Github icon from React Icons
...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      icon: FaCogs, // Using HTML5 icon from Font Awesome
    },
    {
      image: 'project3.jpg',
      headline: 'Project 3',
      ...
      icon: FaCogs, // Using C# icon from Font Awesome
    },
    {
      image: 'project4.jpg',
      headline: 'Project 4',
